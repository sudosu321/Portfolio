...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#faf8f5] text-[#1a1612] font-sans overflow-x-hidden">
      ...
      {/* ── NAV ── */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 md:px-16 py-5 md:py-6 bg-[#faf8f5]/85 backdrop-blur-md border-b border-black/10">
          ...
          {["Resume"].map((item) => (
            <li key={item}>
              <a
                ...
                className="text-[0.82rem] font-normal text-[#6b6560] uppercase tracking-widest hover:text-[#1a1612] transition-colors no-underline"
              >
                {item}
              </a>
            </li>
        ...
        {menuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-[#faf8f5] border-b border-black/10 px-6 py-5 flex flex-col gap-5">
            <a href="/works/resume.pdf" target="_blank" rel="noopener noreferrer" className="text-[0.82rem] font-normal text-[#6b6560] uppercase tracking-widest hover:text-[#1a1612] transition-colors no-underline">
              Resume
            </a>
      ...
      {/* ── HERO ── */}
      <section className="min-h-screen grid grid-cols-1 md:grid-cols-2 items-end gap-10 md:gap-16 px-6 md:px-16 pt-28 md:pt-32 pb-12 md:pb-16 relative overflow-hidden">
        {/* background glow */}
        ...
        <div className="flex items-end justify-center md:justify-end">
          <div className="relative rounded-[2rem] overflow-hidden w-full max-w-[420px] aspect-[4/5] transition-transform duration-500 hover:scale-105 shadow-[0_32px_64px_rgba(216,90,48,0.25)]">
            <Image
      ...
      {/* ── ABOUT ── */}
      <section className="px-6 md:px-16 py-20 md:py-28 bg-[#1a1612] text-white grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-center">
        <div>
      ...
      {/* ── FOOTER ── */}
      <footer className="px-6 md:px-16 py-8 border-t border-black/10 flex flex-col md:flex-row justify-between items-center gap-4 bg-[#faf8f5]">
        ...
        <div className="flex gap-6">
          <a href="mailto:shubhsrijan15@gmail.com" className="text-[0.78rem] text-[#6b6560] no-underline hover:text-[#D85A30] transition-colors">
          ...
          <a href="tel:+917209682555" className="text-[0.78rem] text-[#6b6560] no-underline hover:text-[#D85A30] transition-colors">
            +91 720-968-2555
          </a>
        </div>
      </footer>
